...
class Generator {
        ...
        const instructionsText = [
            {
                ...
                message: "To learn more select 'Instructions' for details. Select 'Skip' to start.",
    ...
    createManager(role){
        ...
        .then(({ officeNumber }) => {
            ...
            const manager = new Manager(this.employee.name, this.employee.email, 'Manager', officeNumber);
    ...
    createEngineer(role){
        ...
        .then(({ githubUsername }) => {
            ...
            const engineer = new Engineer(this.employee.name, this.employee.email, 'Engineer', githubLink);
    ...
    createIntern(role){
        ...
        .then(({ internSchool }) => {
            const intern = new Intern(this.employee.name, this.employee.email, 'Intern', internSchool);
